...
import com.zhuye.hougong.model.db.DBHelpter;
...
public class ContactDao {
    ...
    public List<UserInfo> getContacts(){
        ...
        while (cursor.moveToNext()){
            ...
            userInfo.setNickname(cursor.getString(cursor.getColumnIndex(ContactTable.COL_USER_NICK)));
    ...
    public void saveContact(UserInfo user, boolean isMyContact){
        ...
        contentValues.put(ContactTable.COL_USER_NICK,user.getNickname());
