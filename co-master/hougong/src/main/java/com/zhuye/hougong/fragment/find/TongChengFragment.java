...
public class TongChengFragment extends BaseFindFragment {
    ...
    protected void initView() {
        super.initView();
        adapter = new FindTongChengAdapter(getActivity());
    ...
    protected void initData() {
        super.initData();
        city_code = Sputils.getString(getActivity(),"code","201");
        //initFindBaseData(2,city_code,1,adapter);
        initFindData(page);
    }



    private void initFindData(int page) {
            ...
            public void OnItemClick(View view, final int position) {
                ...
                tv.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View view) {
                        ...
                        //点赞
                        //先从服务器获取shuju数据todo  有问题  点赞数保存到本地
//                        getDataFromServer();
//                        //从zan_id 判断是否已赞
//                        if(dongTaiGuanzhuBean==null){
//                            return;
//                        }
    ...
    DongTaiBean dongTaiGuanzhuBean;
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if(response.body().contains("200")){
                            Gson gson = new Gson();
                            try {
                                dongTaiGuanzhuBean = gson.fromJson(response.body(),DongTaiBean.class);
                            } catch (JsonSyntaxException e) {
                                e.printStackTrace();
                            }
                        }
